...
<html>
    <head>
        <title>Home</title>
        <link rel="icon" href="source/portfolio_icon.png">
    ...
    <body>
        ...
        <div class="video-container">
            ...
            <video autoplay muted loop>
                <source src="source/bgvideo-edited.mp4" type="video/mp4">
            ...
            <div class="overlay-text">
                <p class="title">Hi, I'm Gui Yu Qin</p>
                <p class="subtitle">from Melaka, Malaysia.</p>
            </div>
        </div>
